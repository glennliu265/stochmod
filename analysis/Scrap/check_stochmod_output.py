...
Note: 20220927 --> Appears to be a script to visualize
stochastic model output at a single point. No longer works as
the output no longer exists... potentially delete. 
